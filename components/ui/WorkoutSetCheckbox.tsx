...
import type { CheckboxProps } from "@/node_modules/expo-checkbox/src/Checkbox.types"
        ...
        style={
          showHitSlop
            ? {
                ...
                marginTop: -resolvedHitSlop.top,
                marginBottom: -resolvedHitSlop.bottom,
                marginLeft: -resolvedHitSlop.left,
                marginRight: -resolvedHitSlop.right,
                paddingTop: resolvedHitSlop.top,
                paddingBottom: resolvedHitSlop.bottom,
                paddingLeft: resolvedHitSlop.left,
                paddingRight: resolvedHitSlop.right,
              }
            : undefined
        }
      >
        <Pressable
          {...other}
          hitSlop={resolvedHitSlop}   // ✅ actual hitSlop
          disabled={disabled}
