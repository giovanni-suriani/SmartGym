...
export const DUMMY_WORKOUT: typos.Workout = {
    ...
    // exercises: [DUMMY_EXERCISE_DUMBBELL, DUMMY_EXERCISE_WEIGHT],    
    ...
    // exercises: [DUMMY_EXERCISE_DUMBBELL, DUMMY_EXERCISE_WEIGHT, DUMMY_EXERCISE_CABLE, DUMMY_EXERCISE_SMITH, DUMMY_EXERCISE_CARDIO, DUMMY_EXERCISE1, DUMMY_EXERCISE2, DUMMY_EXERCISE3],    
}